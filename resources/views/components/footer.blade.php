                                ...
                                <div class="wrap-contact-detail">
                                    <ul>
                                        <li>
                                            ...
                                            <p class="contact-txt">8 Jln 30A/146 Taman Desa Tasik 57000 Wilayah Persekutuan Malaysia</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="contact-txt">(+60) 12-345 6789</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="contact-txt">snkys@myshoe.com</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-hotline-footer">
                                    ...
                                    <b class="phone-number">(+60) 12-345 6789</b>
                                </div>
                            </div>
                        </div>
        ...
        <div class="coppy-right-box">
            <div class="container">
                <div class="coppy-right-item item-left">
                    <p class="coppy-right-text">Copyright © 2022 SNKYS. All rights reserved</p>
                </div>
